...
public class Dungeon_4 implements Screen {
    ...
    public Dungeon_4(MyGdxGame game, Array<Texture> ISlots, int floor, ArrayList<Integer> Dungeon_list, float health, float level, int[] itemsCollect, boolean first1, float[] hungers, int[] stats) {
        this.game = game;
        this.ISlots = ISlots;
        this.Health=health;
        this.Level=level;
    ...
    private void worldcheck() {
        Dungeon_list.add(4);
        map1 = new TmxMapLoader( ).load("dungeons/dungeon_4.tmx");
        tiledMapRenderer = new OrthogonalTiledMapRenderer(map1, 2);
