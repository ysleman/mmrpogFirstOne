...
public class Dungeon_1 implements Screen {
    ...
    public Dungeon_1(MyGdxGame game, Array<Texture> ISlot1, int floor, ArrayList<Integer> dungeon_list, float health, float level, int[] items1Collect, boolean first1, float[] hungers, int[] stats){
        this.game=game;
        this.ISlots=ISlot1;
        this.Health=health;
        this.Level=level;
        ...
        Hunger=new float[4];
        Stats=new int[10];
        getrat_items=items1Collect[0];
        getsheep_meat=items1Collect[1];
        getwood_items1=items1Collect[2]*4;
        getstone_items1= items1Collect[3]*4;
        getfish_items=items1Collect[4];
        getIron_items=items1Collect[5];
        getGold_items=items1Collect[6];
        Helemt_gold_item= items1Collect[7];
        chest_gold_item= items1Collect[8];
        leg_gold_item=items1Collect[9];
        foot_gold_item=items1Collect[10];
        Helemt_metal_item =items1Collect[11];
        chest_metal_item=items1Collect[12];
        leg_metal_item= items1Collect[13];
        foot_metal_item= items1Collect[14];
    ...
    private void worldcheck() {
        ...
        Dungeon_list.add(1);
        map1=new TmxMapLoader().load("dungeons/dungeon_1.tmx");
        ...
        myinputproccer=new Myinputproccer(player1,map1, PIXEL_PER_METER,Worldbegginerplace.momvent);
    ...
    private void ChangeScreenHoles() {
        ...
        if(onhole1&&length>=0&&length<=10){
            ...
            game.Dungeon_change(ISlots,random_mobs.Dungeon,FloorNUM+1,Dungeon_list,Health,Level,ItemsCollect,first,Hunger,Stats);
        }
        ...
        //Todo: make the return to surfce by stairs and end higgest floor
    }
