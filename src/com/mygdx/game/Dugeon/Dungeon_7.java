...
public class Dungeon_7 implements Screen {
    ...
    public Dungeon_7(MyGdxGame game, Array<Texture> ISlots, int floor, ArrayList<Integer> Dungeon_list, float health, float level, int[] itemsCollect, boolean first1, float[] hungers, int[] stats){
        this.game=game;
        this.ISlots=ISlots;
        this.Health=health;
        this.Level=level;
    ...
    private void worldcheck() {
        Dungeon_list.add(7);
        map1=new TmxMapLoader().load("dungeons/dungeon_7.tmx");
        tiledMapRenderer = new OrthogonalTiledMapRenderer(map1,2);
    ...
    private void check() {
        for (int i=0;i<106;i++)for(int j=0;j<60;j++){
